...
module.exports = function(dict) {
    ...
    this.then(/^I expect title( not)* to be "$string"$/, require('../helper/checkTitle'))
        ...
        .then(/^I expect a cookie "$string"( not)* to contain "$string"$/, require('../helper/checkCookieContent'))
